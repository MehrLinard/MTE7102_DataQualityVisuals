...
\newglossaryentry{terraform}
{
    name={Terraform},
    text={teraform},
    description={An infrastructure-as-code tool developed by HashiCorp that allows cloud infrastructure to be defined, deployed, and managed through configuration files}
}
