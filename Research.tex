...
Based on the work performed in previous research \cite{Roccaro2026_Project1}, which analysed the existing data pipelines at Swiss Post in regards to operative reporting. The next logical steps were to adapt the existing reports to new reporting plattforms. However in the meantime the reporting datapipelines were updated. The old data pipelines were kept online, however all updates are only performed on the new ones. Due to this development the focus of this project is to follow these changes and helping the team in getting a better check of the existing data. Furthermore it was most important to perform the groundwork for the upcomming master thesis. Thus checking if the provided tools can be used as basis of a usecase deepened in thesis.
...
This project is the important step towards setting the groupwork for the upcomming master thesis. It is confirming possible tools beeing available for ....
