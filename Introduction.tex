...
\section{Todo}
Rewrite required or at least update
\section{From here}
...
The document concludes with the critical review and lessons learned, summarising what went well and what did not, and offering specific suggestions on which methods to retain or replace. This will be valuable for forthcoming projects (PA2, Master’s thesis) that will be carried out following this project. Finally, additional materials are provided in the appendix.