...
\addbibresource{MTE7102_DataQualityVisuals.bib}
...
% Prevent blank pages inserted for odd/even page alignment
\makeatletter
...
\subtitle{Automating data quality validations in Amazon Athena: An MVP based approach}
...
\version{1.0}
\titlegraphic{\includegraphics[width=\width]{./content/img/TitlePage_V1.png}}
